...
//also need to create input form for users to add new elements to table
...
function populateTable(){
    for (let i = 0; i < myLibrary.length; i++){
        ...
        cell4.setAttribute('id', `read_status${i}`);
        if (myLibrary[i].read) {
        ...
        newReadToggleBtn.setAttribute('id', i);
        ...
        newDeleteRowBtn.setAttribute('id', i);
